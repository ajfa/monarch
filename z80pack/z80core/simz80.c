...
#include "simglb.h"
#ifdef MACHINE_TICK
extern void machine_tick(void);
static Tstates_t machine_tick_next;
#endif
#include "simmem.h"
#include "simcore.h"
#include "simport.h"
...
void cpu_z80(void)
{
	...
	do {
		...
		/* machine tick, paced by emulated time (see monarchsim) */
#ifdef MACHINE_TICK
		if (T >= machine_tick_next) {
			machine_tick_next = T + MACHINE_TICK;
			machine_tick();
		}
#endif
